    ...
    <div className="w-full max-w-3xl mx-auto flex items-center justify-between">
      ...
      <Dialog.Root>
        <Dialog.Trigger
          ...
          gap-3 hover:border-violet-300 transition-colors focus:outline-none 
          focus:ring-2 focus:ring-violet-600 focus:ring-offset-2 focus:ring-offset-background"
        >
        ...
        <Dialog.Portal>
          ...
          <Dialog.Content className="absolute p-10 bg-zinc-900 rounded-2xl w-full max-w-md top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
            ...
            >
              <X
                size={24}
                aria-label="Botão para fechar o modal de criação de hábito"
              />
            </Dialog.Close>
